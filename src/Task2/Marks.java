...
public abstract class Marks {
    ...
    We have to calculate the average of marks obtained in three subjects
     ...
     of marks. Provide implementation of abstract method in classes
      'A' and 'B'. The constructor of student A takes the marks in three
...
class StudentB extends Marks{
    double biologyScore;
    StudentB(double mathScore, double historyScore, double scienceScore,double biologyMarks){
        super(mathScore,historyScore,scienceScore);
        this.biologyScore =biologyMarks;
    }
